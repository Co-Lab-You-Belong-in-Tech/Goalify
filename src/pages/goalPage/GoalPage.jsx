  ...
  return (
    ...
    <div className={'bg-gray-100 relative h-full w-full min-h-screen'}>
      ...
      <div className="bg-yellow-100 fixed top-0 left-0 w-full h-20 py-5 px-20 flex  justify-between items-center">
        <div
          className={
            'text-lg w-14  h-14 flex justify-center items-center rounded-3xl'
          }
          style={{
            background:
              'radial-gradient(80.62% 68.16% at 49.94% 31.84%, #FEFFDF 20.31%, #B4BDEC 100%)',
          }}
        >
        ...
        <div className={'flex justify-center items-center gap-4'}>
          <div
            className={
              'bg-indigo-800 w-10 h-10 flex justify-center items-center rounded-3xl'
            }
          >
            <img src={plus} />
          </div>
      ...
      <div className="h-full  p-5  mt-20">
        ...
        <div className="grow   h-full w-2/4 mx-[24%]">
          ...
          <div className="border-2 border-gray-200 w-fit rounded-full p-2 flex  font-semibold gap-3 text-slate-600 leading-5  mb-4">
            <button
              onClick={() => {
                setCategory('completed');
              }}
              className={`${
                category == 'completed' ? 'bg-white' : null
            ...
            <button
              ...
              className={`${
                category == 'in-progress' ? 'bg-white' : null
              } rounded-3xl p-2 text-xl`}
            >
              {' '}
