...
export default function HorizontalLinearStepper({ handleClose }) {
  ...
  const [goalObj, setGoalObj] = useState({
    ...
    startDate: '',
    endDate: '',
    categoryId: categories[selected].id,
  });
  const steps = [
    {
      title: 'Create Goal',
      content: <CreateNewGoalStep setGoal={setGoalObj} />,
    },
    {
      title: 'Develop Milestones',
      content: <DevelopMilestonesStep setGoal={setGoalObj} />,
    },
    {
      title: 'Assign Dates',
      content: <SetDateStep setGoal={setGoalObj} />,
      optional: true,
    },
  ];
